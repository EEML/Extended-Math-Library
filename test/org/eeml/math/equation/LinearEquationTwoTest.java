...
public class LinearEquationTwoTest {
	...
	public void testThrow() {
		assertThrows(HighestCoefficientBeZeroException.class, () -> new LinearEquationTwo(0, 2, 1, 3, 1, 2));
		assertThrows(HighestCoefficientBeZeroException.class, () -> new LinearEquationTwo(9, 0, 1, 3, 1, 2));
		assertThrows(HighestCoefficientBeZeroException.class, () -> new LinearEquationTwo(4, 2, 1, 0, 1, 2));
		assertThrows(HighestCoefficientBeZeroException.class, () -> new LinearEquationTwo(2, 2, 1, 3, 0, 2));
		assertThrows(NotSolvableException.class, () -> new LinearEquationTwo(2, 4, 6, 1, 2, 3));
	}
